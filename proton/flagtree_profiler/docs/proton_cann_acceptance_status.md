...
```bash
python third_party/FlagPrism/proton/flagtree_profiler/scripts/cann_native_acl_mstx_validate.py \
  --clean \
...
python third_party/FlagPrism/proton/flagtree_profiler/scripts/cann_real_msprof_validate.py \
  --clean \
