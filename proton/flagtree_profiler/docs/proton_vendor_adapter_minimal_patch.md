...
- `third_party/FlagPrism/proton/csrc/include/Data/Artifacts.h`
...
- `third_party/FlagPrism/proton/flagtree_profiler/csrc/include/Profiler/Vendor/Mode.h`
- `third_party/FlagPrism/proton/flagtree_profiler/csrc/lib/Profiler/Vendor/Mode.cpp`
...
- `third_party/FlagPrism/proton/flagtree_profiler/csrc/include/Profiler/Vendor/Adapter.h`
- `third_party/FlagPrism/proton/flagtree_profiler/csrc/lib/Profiler/Vendor/Adapter.cpp`
...
- `third_party/FlagPrism/proton/flagtree_profiler/csrc/include/Driver/Ascend/AscendApi.h`
- `third_party/FlagPrism/proton/flagtree_profiler/csrc/include/Profiler/Vendor/CannProfiler.h`
- `third_party/FlagPrism/proton/flagtree_profiler/csrc/lib/Profiler/Vendor/CannAdapter.cpp`
- `third_party/FlagPrism/proton/flagtree_profiler/csrc/lib/Driver/Ascend/AscendApi.cpp`
- `third_party/FlagPrism/proton/flagtree_profiler/csrc/lib/Profiler/Vendor/CannProfiler.cpp`
...
- `third_party/FlagPrism/proton/flagtree_profiler/test/test_cann_smoke.py`
...
- `third_party/FlagPrism/proton/common/include/Device.h`
- `third_party/FlagPrism/proton/csrc/lib/Driver/Device.cpp`
...
- `third_party/FlagPrism/proton/csrc/include/Session/Session.h`
- `third_party/FlagPrism/proton/csrc/lib/Session/Session.cpp`
- `third_party/FlagPrism/proton/csrc/include/Data/Data.h`
- `third_party/FlagPrism/proton/csrc/lib/Data/Data.cpp`
...
- `third_party/FlagPrism/proton/proton/profile.py`
- `third_party/FlagPrism/proton/proton/proton.py`
...
python -c "import flagtree.profiler as proton; print(proton.start)"
```
...
- `third_party/FlagPrism/proton/test/test_api.py` imports `torch` during collection through Triton's internal test helpers, so it requires a PyTorch installation even when running only a CANN-specific `-k` selection.
