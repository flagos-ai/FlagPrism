...
```bash
python3 -m pytest -q third_party/FlagTree_Tools/proton/flagtree_profiler/test/test_cann_smoke.py -s
```
...
```bash
python3 -m pytest -q third_party/FlagTree_Tools/proton/test/test_cann_smoke.py -s
```
