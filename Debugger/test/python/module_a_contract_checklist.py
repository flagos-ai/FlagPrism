...
"""Shared text: module A acceptance items from docs/debugger_module_contract.md + third_party/FlagTree_Tools/Debugger/include/Debugger/README.md.
...
【§5】§5.1.1 mock 句柄经 Debugger launch context 进入 Ascend launch；
§5.2 A-1/A-2/A-3；§5.3 CTT-1（scope_id/负例）、CTT-3（hidden_arg 注入 ABI）。

【§6.1 A 侧可测】编译成功、metadata/TTIR/launch 实参可观测代理。

【third_party/FlagTree_Tools/Debugger/include/Debugger/README.md】debug_tracked_table 行与 TrackedOpTable 契约一致，A 仅透传不另造 schema。
