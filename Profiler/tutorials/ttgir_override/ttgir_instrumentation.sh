...
# This script demonstrates FlagTree Profiler TTGIR instrumentation.
...
echo "Now run `flagtree-profiler-viewer -m normalized_cycles vector-add.hatchet` to see the output"
