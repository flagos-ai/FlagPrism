...
这个例子专门用于演示 `profile.timeline.json`。它会直接运行，不需要传参：
    ...
    python3 third_party/FlagPrism/Profiler/examples/timeline_showcase_profile.py
...
查看 Hatchet：
    ...
    flagtree-profiler-viewer -m time/us,cann.task_duration_us,cann.task_wait_time_us,cann.bandwidth_gb_s,cann.memory_access_bytes \
      /tmp/flagtree_profiler_examples/timeline_showcase/profile.hatchet
