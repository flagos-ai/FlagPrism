...
在 FlagTree 昇腾容器内运行：
    ...
    python3 third_party/FlagPrism/Profiler/examples/simple_vector_add_profile.py
...
环境变量 FLAGTREE_PROFILER_CANN_PROFILE_OUTPUT=/path/to/msprof。
...
预期数据：
    ...
    - timeline.json: traceEvents 包含 Profiler/CANN timeline events
