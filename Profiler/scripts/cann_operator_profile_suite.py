...
def _make_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--out", default="/tmp/flagtree_profiler_cann_triton_operator_suite")
...
def _summarize_post_import(out: pathlib.Path, post_import_base: pathlib.Path) -> dict:
    ...
    triton_ranges = [msg for msg in mstx_messages if msg.startswith("flagtree_profiler_cann_triton::")]
...
def _run_driver(args: argparse.Namespace) -> int:
    ...
    baseline_summary = (
        json.loads(baseline_summary_path.read_text())
